...
def parse_args():
    ...
    parser.add_argument('--data_root', type=str, default= RELATIVE_PATH + 'data')
    # model bert-base-uncased will be download to 
    # 'C:\Users\Administrator\.cache\huggingface\hub\models--bert-base-uncased' by default.
    parser.add_argument('--model', type=str, default='bert-base-uncased')
    parser.add_argument('--output_dir', type=str, default=RELATIVE_PATH + 'experiments')
...
def main():
    ...
    # Set seed before intiializing model, for reproduction purpse.
    set_seed(args.seed)
